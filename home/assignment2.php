...
{
    $stid=$_REQUEST['stid'];
    $stname=$_REQUEST['stnm'];
    $cname=$_REQUEST['cnm'];
    $tarea=$_REQUEST['textarea'];
    $sql="insert into assignments_info(stu_id,stu_name,course_name,course_assignment)values('$stid','$stname','$cname','$tarea')";
    ...
    <form action="" class="decor" method="post">
      ...
      <div class="form-inner">
        ...
        <select class="dropdown" name="cnm" id="cnm">
         ...
         <input type="text" placeholder="Student name" name="stnm" id="stnm">
        <input type="text" placeholder="Student id" name="stid" id="stid">
        <textarea placeholder="Type assignment.." rows="5" name="textarea" id="textarea"></textarea>
